...
class SignIn {
  ...
  static Future signIn(
    ...
    var request = Request('POST', Uri.parse(usualLogin));
  ...
  static Future authenticateWithMobileId() async {
    var request = Request('POST', Uri.parse(mobileIdLogin));
    request.headers['Content-Type'] = 'application/json';

    request.body = jsonEncode(<String, String>{
      'mobileId': getMobileId().toString(),
    });
...
Future getMobileId() async {
  ...
  if (Platform.isAndroid) {
    ...
    var deviceData = _readIosDeviceInfo(await deviceInfoPlugin.iosInfo);
